...
(:objects 
        ...
        libro_0 libro_1 libro_2 libro_3 libro_4 libro_5 libro_6 libro_7 libro_8 libro_9 - libro
)
(:init 
        ...
        (predecesor libro_2 libro_6)
        (paralelo libro_0 libro_7)
        (predecesor libro_0 libro_9)
        (predecesor libro_1 libro_7)
        (predecesor libro_1 libro_8)
        (predecesor libro_2 libro_7)
        (predecesor libro_3 libro_8)
